...
static void fst_process_tx_work_q(struct tasklet_struct *t);
static void fst_process_int_work_q(struct tasklet_struct *t);
...
static void
fst_process_tx_work_q(struct tasklet_struct *t)
{
	unsigned long flags;
	u64 work_txq;
	int i;
...
static void
fst_process_int_work_q(struct tasklet_struct *t)
{
	unsigned long flags;
	u64 work_intq;
	int i;
